...
<p class="alert alert-info">There is another, shortcut syntax for looping through lists (to create other lists) called _list comprehensions_. These are discussed in more detail in a [below](#list-comprehensions).</p>
